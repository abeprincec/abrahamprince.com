...
export default function Nav() {
  ...
  return (
    <nav className="fixed top-0  w-full py-2 bg-white border-b border-gray-400  border-opacity-20 bg-opacity-90 dark:bg-black dark:bg-opacity-90  dark:border-opacity-10 filter-blur h-12">
